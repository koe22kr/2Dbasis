...
#include "Card.h"
static const char* ADDRESS = "192.168.0.61";

enum Custom_ERROR_CODE //1바이트 안으로
{
    HIT_FAIL = 101
};
...
/////접속 관련//////////////////////가입, 로그인 NAME 구조체 받아야.
//////////////////////////////////////////////////////////
#define PACKET_ACCESS_RQ 2001          //>>NO DATA -> 로그인 전 접속요청??
...
//<<1 바이트  flag 값 보내기. 1 == 성공   0 == 실패 //for 문으로 현재 접속중 유저 인포 보내야.
#define PACKET_JOIN_NEW_USER 2007
//<<USER_INFO         


///////////////////////////////////////////////////////////////////////////////////////////////////////////
#define PACKET_DEALER_HIT 900 //CARD DATA;
...
#define PACKET_SOME_BODY_HIT 4003               //<<User_Card_Info        //// 패킷 보내면
...
//#define PACKET_PHASE_CHANGE 8003 //1바이트 정수 로 페이즈 값 보내기 음? 필요한가?...
