...
void Player_Mgr::Packet_Cutting(Player target_player, char* pBuffer, DWORD dwByte)
{//find User 해서 end()가 아니라면 Player[UID] 를 target_user 로 던지.
    ...
    memcpy(&target_player.m_szPack_Stream[target_player.m_dwWrite_Pos], pBuffer, dwByte);
